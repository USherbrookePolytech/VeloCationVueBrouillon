...
public class Maintenance
{
    ...
    private void initialize()
    {
        ...
        JButton btnAjouterDesSocles = new JButton("Gérer les socles");
        ...
        gl_MaintPanelSocles.setHorizontalGroup(
                gl_MaintPanelSocles.createParallelGroup(Alignment.LEADING).addGroup(gl_MaintPanelSocles
                        .createSequentialGroup()
                        .addGroup(gl_MaintPanelSocles.createParallelGroup(Alignment.LEADING)
                                .addGroup(gl_MaintPanelSocles.createSequentialGroup().addGap(178)
