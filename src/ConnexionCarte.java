...
public class ConnexionCarte
{
    ...
    private void initialize()
    {
        ...
        CxCarteScannerLogo.setIcon(new ImageIcon(
                ConnexionCarte.class.getResource("/com/sun/java/swing/plaf/motif/icons/DesktopIcon.gif")));
        ...
        gl_CxCartePanelId.setVerticalGroup(gl_CxCartePanelId.createParallelGroup(Alignment.LEADING)
                .addGroup(gl_CxCartePanelId.createSequentialGroup().addContainerGap()
                        ...
                        .addGroup(gl_CxCartePanelId.createParallelGroup(Alignment.BASELINE)
                                .addComponent(CxCarteLblVotreId).addComponent(CxCarteTxtId, GroupLayout.PREFERRED_SIZE,
